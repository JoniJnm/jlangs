<div class="form-horizontal" autocomplete="off">
	<div class="form-group" id="filter-project">
		...
		<div class="col-sm-2">
			<button class="delete btn btn-danger" style="display:none">Delete</button>
		</div>
	</div>
	<div class="form-group" id="filter-bundle">
		<label class="col-sm-2 control-label">Bundle</label>
		<div class="col-sm-8">
			<select class="form-control" name="bundle"></select>
		</div>
		<div class="col-sm-2">
			<button class="delete btn btn-danger" style="display:none">Delete</button>
		</div>
	</div>
	<div class="form-group" id="filter-key">
